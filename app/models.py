from sqlalchemy import Column, Integer, String, BigInteger, DateTime, func, UniqueConstraint, Index
...
class SpimexTradingResult(Base):
    ...
    __table_args__ = (
        # Предотвращаем дубликаты: уникальная пара product_id + дата торгов
